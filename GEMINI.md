# Flutter Development Mandates

Instructions found in this `GEMINI.md` file are foundational mandates. They take absolute precedence over the general workflows and tool defaults.
