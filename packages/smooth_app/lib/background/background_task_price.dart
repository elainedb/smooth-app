...
abstract class BackgroundTaskPrice extends BackgroundTask {
  ...
  BackgroundTaskPrice.fromJson(super.json)
    : date = JsonHelper.stringTimestampToDate(json[_jsonTagDate] as String),
      ...
      discountTypes = _normalizeListString(
  ...
  /// Normalizes a list of strings to match the expected [length].
  ///
  /// Returns a list of empty strings if [input] is null (backward compat).
  static List<String> _normalizeListString(
    ...
    return <String>[...input, ...List<String>.filled(length - input.length, '')];
  }
