...
abstract class BackgroundTaskPrice extends BackgroundTask {
  ...
  /// Normalizes the discount types list to match expected length.
  ///
  /// Defaults to empty strings for backward compatibility with tasks
  /// serialized before discount types were added.
