...
abstract class BackgroundTaskPrice extends BackgroundTask {
  ...
  BackgroundTaskPrice.fromJson(super.json)
    : date = JsonHelper.stringTimestampToDate(json[_jsonTagDate] as String),
      ...
      discountTags = _normalizeDiscountTags(
        _fromJsonListString(json[_jsonTagDiscountTags]),
  ...
  static const String _jsonTagDiscountTags = 'discountTags';
  ...
  static List<String> _normalizeDiscountTags(
  ...
  final List<String> discountTags;
  ...
  Map<String, dynamic> toJson() {
    ...
    result[_jsonTagDiscountTags] = discountTags;
  ...
  Future<void> addPrices({
    ...
    if (split) {
      for (int i = 0; i < barcodes.length; i++) {
        ...
        await BackgroundTaskAddOtherPrice.addTask(
          ...
          discountTags: <String>[discountTags[i]],
    ...
    for (int i = 0; i < barcodes.length; i++) {
      ...
      final Price newPrice = Price()
        ...
        ..discountType = (priceIsDiscounted && discountTags[i].isNotEmpty)
            ? DiscountType.fromOffTag(discountTags[i])
            : null
