...
abstract class BackgroundTaskPrice extends BackgroundTask {
  ...
  /// Normalizes the discount types list to match the expected [count].
  ///
  /// Handles backward compatibility when the field is missing from old data.
  static List<String> _normalizeDiscountTypes(
    ...
    return <String>[
      ...input,
      ...List<String>.filled(count - input.length, ''),
    ];
  }
