...
abstract class BackgroundTaskPrice extends BackgroundTask {
  ...
  static List<String> _normalizeDiscountTypes(Map<String, dynamic> json) {
    final List<dynamic>? barcodes =
        json.containsKey(_jsonTagBarcode)
            ? <String>[json[_jsonTagBarcode] as String]
            : json[_jsonTagBarcodes] as List<dynamic>?;
    final int count = barcodes?.length ?? 1;
