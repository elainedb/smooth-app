...
abstract class BackgroundTaskPrice extends BackgroundTask {
  ...
  /// Normalizes the discount types list to match [count], filling missing
  /// entries with empty strings for backward compatibility.
  static List<String> _normalizeDiscountTypes(
    ...
    return <String>[...input, ...List<String>.filled(count - input.length, '')];
  }
