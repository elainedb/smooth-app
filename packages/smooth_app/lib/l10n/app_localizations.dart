...
abstract class AppLocalizations {
  ...
  /// No description provided for @prices_discount_loyaltyProgram.
  ///
  /// In en, this message translates to:
  /// **'Loyalty program'**
  String get prices_discount_loyaltyProgram;

  /// No description provided for @prices_discount_expiresSoon.
  ///
  /// In en, this message translates to:
  /// **'Expires soon'**
  String get prices_discount_expiresSoon;

  /// No description provided for @prices_discount_pickItYourself.
  ///
  /// In en, this message translates to:
  /// **'Pick it yourself'**
  String get prices_discount_pickItYourself;

  /// No description provided for @prices_discount_secondHand.
  ///
  /// In en, this message translates to:
  /// **'Second hand'**
  String get prices_discount_secondHand;
