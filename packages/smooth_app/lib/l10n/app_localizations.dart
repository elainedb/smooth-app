...
abstract class AppLocalizations {
  ...
  /// No description provided for @prices_amount_discount_type_label.
  ///
  /// In en, this message translates to:
  /// **'Discount type'**
  String get prices_amount_discount_type_label;

  /// No description provided for @discount_type_quantity_discount.
  ///
  /// In en, this message translates to:
  /// **'Quantity discount'**
  String get discount_type_quantity_discount;
