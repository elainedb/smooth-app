...
abstract class AppLocalizations {
  ...
  /// No description provided for @prices_amount_discount_type_quantity.
  ///
  /// In en, this message translates to:
  /// **'Quantity discount'**
  String get prices_amount_discount_type_quantity;
  ...
  /// No description provided for @prices_amount_discount_type_loyalty.
  ///
  /// In en, this message translates to:
  /// **'Loyalty program'**
  String get prices_amount_discount_type_loyalty;
