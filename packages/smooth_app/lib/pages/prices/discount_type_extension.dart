...
extension DiscountTypeExtension on DiscountType {
  String getTitle(final AppLocalizations appLocalizations) => switch (this) {
    DiscountType.quantity =>
      appLocalizations.prices_discount_type_quantity,
    DiscountType.sale =>
      appLocalizations.prices_discount_type_sale,
    DiscountType.seasonal =>
      appLocalizations.prices_discount_type_seasonal,
    ...
    DiscountType.other =>
      appLocalizations.prices_discount_type_other,
  };
}
