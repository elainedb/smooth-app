...
/// Read-only field displaying the discount type of an existing price.
class PriceExistingDiscountTypeField extends StatelessWidget {
  ...
  /// The discount type to display (`null` means none).
  ...
  Widget build(BuildContext context) {
    ...
    final TextEditingController controller = TextEditingController(
      text: value == null ? '' : value!.getTitle(appLocalizations),
    );
    return Padding(
